...
public class US_7330 extends BaseTest {
	...
	@Test(description = "This test case is designed to test full commission movement during QnB process", dataProviderClass = DataProviderUtils.class, dataProvider = "ssBVTDataProvider",alwaysRun=true)
	
	public void TC_7330_FullCommMovementQnBProcess(String browser) throws Exception {
